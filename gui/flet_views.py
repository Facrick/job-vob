...
class ScoutTabView(ft.BaseControl):
    ...
    def build(self):
        ...
        self.combo_status_filter = ft.Dropdown(
            ...
            value="all",
            on_change=lambda e: self.controller.refresh_table_data()
        )
...
class LettersTabView(ft.BaseControl):
    ...
    def build(self):
        ...
        self.btn_apply_feedback = ft.ElevatedButton(text="🛠️ Применить правки", on_click=self.controller.handle_feedback)
        
        self.btn_auto_apply = ft.ElevatedButton(text="🚀 Отправить автоотклик", on_click=self.controller.handle_auto_apply, bgcolor=ft.colors.GREEN, color=ft.colors.WHITE)
...
class InterviewTabView(ft.BaseControl):
    ...
    def build(self):
        ...
        self.btn_start_mock = ft.ElevatedButton(text="🚀 Начать собеседование", on_click=self.controller.handle_start_mock)
        self.btn_reset_mock = ft.ElevatedButton(text="🔄 Сбросить", on_click=self.controller.handle_reset_mock)
...
class AnalyticsTabView(ft.BaseControl):
    ...
    def build(self):
        ...
        self.btn_draw_chart = ft.ElevatedButton(text="📈 Рассчитать и обновить график", on_click=self.controller.draw_analytics_chart)
